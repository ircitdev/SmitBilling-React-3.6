...
export const StatsBar: React.FC = () => {
  const stats = [
    ...
    {
      value: '450 000+',
      label: 'Записей перенесено',
      sublabel: 'Клиенты, договоры, платежи и остатки при переходе',
      icon: Bot,
      spark: [50, 42, 60, 54, 70, 64, 84],
    },
    {
      // Сверено с каталогом сервера лицензий: 25 активных модулей.
      value: '25',
      label: 'Модулей в каталоге',
