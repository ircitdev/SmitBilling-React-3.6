...
export const PRICING_PLANS: PricingPlan[] = [
  {
    id: 'start',
    name: 'Старт',
    description: 'Базовый биллинг и обязательный СОРМ для небольших операторов',
    monthlyPrice: 9900,
    annualPrice: 99000,
    modulesIncluded: 4,
    features: [
      'Биллинг-ядро + FreeRADIUS 3.2 без ограничений по сессиям',
      'Карта сети (GIS) и базовые SQL-отчёты',
      'СОРМ-3 (13 отчётов по приказу №573)',
      'Личный кабинет абонента и мобильные приложения iOS/Android',
      'Captive Portal (заглушка для должников и гостевой Wi-Fi)',
      'Документооборот (PDF-договоры и акты)',
      'Техническая поддержка и обновления включены',
    ],
    targetAudience: 'До 500 активных абонентов',
    subscribersCapacity: 'Оптимально до 500 абонентов',
  },
  {
    id: 'pro',
    name: 'Pro',
    description: 'Полнофункциональный комплекс для растущего интернет-провайдера',
    monthlyPrice: 24900,
    annualPrice: 249000,
    modulesIncluded: 14,
    highlighted: true,
    ...
    features: [
      'Всё, что входит в тариф «Старт»',
      'Авторазбор банковских выписок (Сбербанк, Альфа-Банк, 1С)',
      'Фискализация по 54-ФЗ (чеки в ОФД через АТОЛ Онлайн)',
      'Складской учёт ТМЦ, серийные номера и сканер штрихкодов',
      'Омниканальная служба поддержки (HelpDesk) и тикеты',
      'CRM для телекома с воронками подключения и нарядами',
      'IPTV-интеграция с платформами TVIP Media и «Смотрёшка»',
      'Конструктор сайтов и лендингов из 23 готовых блоков',
      'Облачное видеонаблюдение (VSaaS) с архивом',
      'Собственный почтовый сервер с защитой DKIM/DMARC',
    ],
    targetAudience: 'От 500 до 3 000 абонентов',
    subscribersCapacity: 'До 3 000 абонентов',
  },
  {
    id: 'business',
    name: 'Бизнес',
    description: 'Максимальная автоматизация, AI-поддержка и холдинговый режим',
    monthlyPrice: 37900,
    annualPrice: 379000,
    modulesIncluded: 17,
    features: [
      'Всё, что входит в тариф «Pro»',
      'AI-ассистент первого уровня поддержки на 7 каналах',
      'Мультиорганизация: ведение нескольких юрлиц в одной установке',
      'Раздельные реквизиты, расчетные счета и кассы для каждой компании',
      'IP-телефония: click-to-call, запись и расшифровка звонков',
      'Голосовая почта: приём звонков в нерабочие часы с транскрибацией',
      'Приоритетный SLA технической поддержки с выделенным инженером',
    ],
    targetAudience: 'От 3 000 до 10 000 абонентов',
    subscribersCapacity: 'До 10 000 абонентов',
  },
  {
    id: 'enterprise',
    name: 'Enterprise',
    description: 'Корпоративный масштаб, собственный бренд и индивидуальная доработка',
    monthlyPrice: 49900,
    annualPrice: 499000,
    modulesIncluded: 24,
    features: [
      'Полный пакет всех 24 модулей платформы',
      '100% White-Label: замена любого брендинга на ваш собственный',
      'Модуль голосового автообзвона должников роботом',
      'Геймификация и программы лояльности абонентов',
      'Индивидуальный ETL-перенос базы данных с гарантией целостности',
      'Кластерная отказоустойчивая конфигурация High Availability',
      'Круглосуточный персональный VIP-SLA 24/7/365',
    ],
    targetAudience: 'От 10 000+ абонентов и сети операторов',
    subscribersCapacity: 'Неограниченное число абонентов',
  },
];
...
export const BLOG_ARTICLES: import('../types').BlogArticle[] = [
  {
    ...
    excerpt: 'Анализ 13 нормативных справочников, частые ошибки форматирования HEX и требования ФСБ к расписанию передачи.',
    tag: 'СОРМ-3 · Регулирование',
  ...
  },
  {
    ...
    excerpt: 'Как визуализация ВОЛС, оптических муфт и опор ЛЭП на интерактивной карте сокращает время ликвидации аварий в 4 раза.',
    tag: 'Инфраструктура · ВОЛС',
  ...
  },
  {
    ...
    excerpt: 'Пошаговый разбор механизма автоматического распознавания платежей по ИНН и назначению платежа без участия бухгалтера.',
    tag: 'Финансы · 54-ФЗ',
