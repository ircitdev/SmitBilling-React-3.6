...
// Ждём, пока отрисуются все отложенные секции. Столько <section> у полностью
// собранной страницы: добавили или убрали секцию — поправить здесь, иначе
// сборка упадёт с понятной ошибкой (это лучше, чем молча выложить обрезанную).
